...
namespace Banks.Tests
{
    public class BanksTest
    {
        ...
        public void CancelTransaction()
        {
            ...
            bank.Transfer(5000, Convert.ToInt32(user1.UId), Convert.ToInt32(user2.UId), new DateProvider(21, 2, 22));
            
            Assert.AreEqual(bank.Accounts[bank.FindAccount(user2.UId)].Money, 15000);
            Assert.AreEqual(bank.Accounts[bank.FindAccount(user1.UId)].Money, 0);
        }
